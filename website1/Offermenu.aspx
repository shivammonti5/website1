<%@ Page Title="" Language="C#" MasterPageFile="~/newgymsite.Master" AutoEventWireup="true" CodeBehind="Offermenu.aspx.cs" Inherits="website1.Offermenu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="auto-style31">
        ...
        <asp:Image ID="Image8" runat="server" Height="585px" ImageUrl="~/image/Offerstop.jpg" Width="1464px" />
