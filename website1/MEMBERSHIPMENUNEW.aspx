<%@ Page Title="" Language="C#" MasterPageFile="~/MAINMASTER.Master" AutoEventWireup="true" CodeBehind="MEMBERSHIPMENUNEW.aspx.cs" Inherits="website1.MEMBERSHIPMENUNEW" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="auto-style41">
       <div class="auto-style1">
         <asp:Image ID="Image1" runat="server" Height="561px" ImageUrl="~/image/member.jpg" Width="1593px" />
        ...
        <div class="auto-style5">
            ...
            <span style="color:black;  padding: 5px;" class="auto-style13">SIGN-UP TODAY!
                ...
                <br />
                <asp:CheckBox ID="chckboxSignup" runat="server" Font-Size="X-Small" Text="I am interested in a Membership at Waves Gym Andheri W, Mumbai. Please call me." />
                <br />
            <asp:Label ID="lblMsg" runat="server" Font-Size="Medium" ForeColor="#33CC33"></asp:Label>
&nbsp;<asp:Label ID="lblError" runat="server" Font-Size="Medium" ForeColor="Red"></asp:Label>
                <br />
                <asp:Button ID="Button1" runat="server" Text="SEND" BackColor="#FF3300" Font-Bold="True" Font-Italic="True" Font-Size="X-Large" ForeColor="White" Height="49px" Width="382px" OnClick="Button1_Click" />
            </span>
            <span style="color:black;  padding: 5px;" class="auto-style28"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3769.2271628335884!2d72.82920207505374!3d19.14153118207655!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b63c5bd1db99%3A0x6811ccd18150f496!2sWaves%20Gym%20-%20Best%20Gym%20in%20Lokhandwala%20Andheri%20West!5e0!3m2!1sen!2sin!4v1717308835901!5m2!1sen!2sin" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="auto-style40"></iframe></span>
            <span style="color:black;  padding: 5px;" class="auto-style15">
                <asp:ImageButton ID="ImageButton1" runat="server" CssClass="auto-style16" ImageUrl="~/image/memimg.jpg" Height="466px" Width="482px" />
                <span style="color:white;  padding: 5px;" class="auto-style39">WORK IT!
                    <br />
                    WORK IT!
                     <br />
                    WORK IT!
                ...
                <span style="color:orangered;  padding: 5px;" class="auto-style38">FREE TRIAL</span>
