<%@ Page Title="" Language="C#" MasterPageFile="~/MAINMASTER.Master" AutoEventWireup="true" CodeBehind="offer2.aspx.cs" Inherits="website1.offer2" %>
...
<asp:Image ID="Image8" runat="server" Height="585px" ImageUrl="~/image/Offerstop.jpg" Width="1593px" />
        ...
        <div style="display:flex; justify-content:space-between;" class="auto-style14">
          ...
          <div class="auto-style13">
             ...
             <asp:HyperLink ID="HyperLink6" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="X-Large" ForeColor="Red" Height="95px" Width="475px" CssClass="auto-style13" NavigateUrl="~/offers.aspx">ABCOFFEE</asp:HyperLink>
